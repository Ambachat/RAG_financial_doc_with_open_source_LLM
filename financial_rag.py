...
Original file is located at
    https://colab.research.google.com/drive/1F8D4oE2mzBQAXjL6YzLk3qeTyCGTaEGy
"""

!pip install -q langchain-community langchain-chroma langchain-huggingface \
    pdfplumber sentence-transformers chromadb  rank_bm25
...
# NOTE: Make sure the folder name matches exactly what you created in Drive
drive_folder = "/content/drive/MyDrive/financial_rag_data"

# 3. specific check to ensure it worked
if os.path.exists(drive_folder):
    print(f" Success! Found folder: {drive_folder}")
    print("Files available:", os.listdir(drive_folder))
else:
    print(f" Error: Could not find '{drive_folder}'. Check your folder name in Drive.")
...
FILES = {
    "/content/drive/MyDrive/financial_rag_data/10-Q4-2024-As-Filed.pdf": "Apple10-K",
    "/content/drive/MyDrive/financial_rag_data/tsla-20231231-gen.pdf": "Tesla10-K"
}
...
def setup_database():
    ...
    if os.path.exists(DB_PATH) and os.listdir(DB_PATH):
        ...
        try:
            ...
            # FIX: Check if collection is actually empty
            if len(vectorstore.get()['ids']) > 0:
                print("Database loaded successfully.")
                return vectorstore
        except:
            print("Database check failed. Re-ingesting...")
    ...
    if not raw_docs:
        raise ValueError("No documents extracted! Check file paths.")
